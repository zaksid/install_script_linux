...
sudo apt install -y numix-icon-theme numix-icon-theme-circle >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\tnumix-icon-theme\t\t\tOK" | tee -a install.log
else
    echo -e "\tnumix-icon-theme\t\t\tFail" | tee -a install.log
...
sudo apt install -y radiance-flat-colors >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
...
sudo apt install -y ambiance-blackout-flat-colors >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
...
sudo apt install -y ambiance-flat-colors >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
...
sudo apt install -y sublime-text >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
...
sudo apt install -y vim >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
sudo apt install -y htop >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
sudo apt install -y gparted >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
sudo apt install -y clementine >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
sudo apt install -y openssh-server >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
sudo apt install -y gufw >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
##################### Install screenfetch (OS info tool) #####################
echo -n "Installing screenfetch..." | tee -a install.log
sudo apt install -y screenfetch >> log.txt 2>>log.txt
if [ $? -eq 0 ]; then
    echo -e "\t\t\tOK" | tee -a install.log
else
    echo -e "\t\t\tFail" | tee -a install.log
...
#sudo apt install -y lamp-server^ >> log.txt 2>>log.txt
#if [ $? -eq 0 ]; then
#   echo -e "\t\t\tOK" | tee -a install.log
#else
#   echo -e "\t\t\tFail" | tee -a install.log
...
#sudo apt install -y oracle-java8-installer >> log.txt 2>>log.txt
#if [ $? -eq 0 ]; then
#   echo -e "\t\t\tOK" | tee -a install.log
#else
#   echo -e "\t\t\tFail" | tee -a install.log
